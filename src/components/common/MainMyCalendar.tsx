import React, {
  ...
  import CounselingDetailModal from "components/counseling/CounselingDetailModal";
  ...
  const MainMyCalendar: React.FC<MyStatusCalendarProps> = ({
    userNo,
    userType,
  }) => {
    ...
    return (
      <div className='Main-My-status-calendar'>
        <Grid container spacing={2}>
          <Grid item xs={12} md={8}>
            <Paper elevation={3} className='Main-MyCalendar-container'>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={3} className="Main-list-container">
  ...
  export default React.memo(MainMyCalendar);