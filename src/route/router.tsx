  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/emp/assignment/view/:deptId"
        ...
        프로그램 상세페이지
        <Route
          path="/applicant/student/:studentId"
          element={<StudentApplicant />}
        />{" "}
        // 학생 본인신청목록
        <Route path="/applicant" element={<ApplicantList />} /> // 전체 신청
        목록
        <Route path="/emp/manageProgram" element={<ManageProgram />} />
        <Route path="/emp/manageProgram/create" element={<ProgramForm />} /> //
        프로그램 작성
        <Route
          path="/emp/manageProgram/update/:programNo"
